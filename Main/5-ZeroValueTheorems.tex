...
\end{proof}\noindent
We will now call the space of all functions $f:[0,\epsilon]\rightarrow\R_{\geq0}^2$ which obey conditions~\eqref{5-Zeroes-Equ-TOV-Conditions-0} to~\eqref{5-Zeroes-Equ-TOV-Conditions-5} $K$.
\begin{lemma}
...
\begin{proof}
	...
	By lemma~\ref{5-Zeroes-Lem-K-Complete-Convex} this space is complete and convex.
