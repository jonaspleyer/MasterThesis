...
%		|p(x)-p(y)|&=\left|\int\limits_x^y \frac{\rho+p}{r'^2}(4\pi r'^3 p + m)\left(1-\frac{2m}{r'}\right)^{-1}dr'\right|\\
%		&\leq2(\rho_0+p_0)\left|\int\limits_x^y \left(4\pi r' p+\frac{m}{r'^2}\right)dr'\right|\\
%		&\leq2(\rho_0+p_0)\left(p_0\epsilon+\frac{4\pi\epsilon\rho_0}{3}\right)|x-y|
