...
\end{proof}
\begin{proof}[Proof \acrNoHyperlink{\acl}{TOV} Existence]
...
\end{proof}\noindent
While it was not possible in the scope of this work to proof the complete statement of theorem~\ref{5-Zeroes-Theo-Lane-EmdenFiniteBoundary}, there have been some attempts to do so.
A few promising ones will be explained in the next section.