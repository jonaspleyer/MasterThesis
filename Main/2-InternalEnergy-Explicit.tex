...
The integral in equation \ref{2-IntEner-UltraRelZ-Int-eq} can be solved exactly with value $2$. 
In the last line $\beta=(k_BT)^{-1}$ was used for visual clarity.
With equation \ref{2-IntEner-Def} the internal energy $\U = 3Nk_BT$ and with equation \ref{2-IntEner-pressureDef} the equation of state can now be written down
\begin{equation}
...
From equation \eqref{2-IntEner-PartFunc} and \eqref{2-IntEner-FreeEnerDef}, we immediately derive the ideal gas equation via the definition of pressure (see equation \ref{2-IntEner-pressureDef} in the canonical ensemble
\begin{equation}
...
This adiabatic condition is quite well satisfied since radiational and other losses compared to the total amount of mass can be neglected \cite{noerdlingerSolarMassLoss2008}.
Using equation \ref{2-IntEner-InternelEnergyExplicit} and \ref{2-IntEner-pressureDef}, we obtain
\begin{alignat}{3}
    -p\diff V &= C_V\diff T\\
