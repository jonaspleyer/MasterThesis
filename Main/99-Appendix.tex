...
This simple fact which is integral to the concept of an \ac{ODE} means that numerics is single thread bound which already puts one at a systematic disadvantage.
This means any effort to parallelise the given task must focus on distributing the individual solving routines to respective threads\footnote{Thread refers to a sequence of instructions given to a processing unit.}.
...
However in the situation of section \ref{4-NumSol-Sec-TOV-Exponents}
\end{section}
\end{appendix}
