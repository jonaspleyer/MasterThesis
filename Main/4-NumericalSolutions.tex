...
\begin{subsection}{Comparing \acrNoHyperlink{\acs}{TOV} and \acrNoHyperlink{\acs}{LE} results with a polytropic \acrNoHyperlink{\acs}{eos}}% TODO find out how to get EOS here without link
\label{4-NumSol-Sec-Comp-TOV-LE} %TODO here as well
...
Figure \ref{4-NumSol-Plt-TOVEqEasyEOS} shows the solution of both equations for the parameters of table \ref{4-NumSol-Tbl-TOVParameters}.% TODO make table and figure capital
...
\begin{figure}[H]
	...
	\caption[Comparison of the TOV and LE equation]{Comparison of the general relativistic \ac{TOV} result with polytropic \ac{eos} to the classical Lane-Emden solution.% TODO format better to match other descriptions
...
Despite this behaviour we can see that the criterion for convergence is fulfilled in the last column of figure \ref{4-NumSol-Plt-ValidateLEResults}.%TODO figure capital
\begin{figure}[H]
	\centering
