\begin{section}{Calculating the Mass of a Star with an \acrNoHyperlink{\acs}{eos}}
	% TODO swap all abbreviations
\begin{subsection}{Deriving the \acrNoHyperlink{\acs}{TOV}-Equation}
