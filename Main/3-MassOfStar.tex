...
\begin{table}[H]
	...
	\begin{tabular}{@{}lcccc@{}}
		...
		\bottomrule
	\end{tabular}
	\caption[Exact Solutions for the TOV equation]{The table displays 3 different solutions for the exponents $n=0,1,5$ as well as some of their properties.}
	\label{3-Mass-LE-Exact-Results}
\end{table}
% However the fully general-relativistic form
% \begin{equation}
% 	\frac{\partial p}{\partial r} = - \frac{p+\rho}{2r(r-2m)}\left(8\pi r^3p+2m\right)
% \end{equation}
%
%
\end{subsection}
